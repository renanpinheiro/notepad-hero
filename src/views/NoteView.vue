    ...
    <div>
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-2 mb-4">
                <NButton type="secondary" textAlign="left" label="Voltar" customClass="w-fit" @click="handleBack">
                    <template #icon>
            ...
            <div class="flex items-center gap-2 border-b border-gray-200 pb-4">
                <img class="w-6 h-6" src="../assets/note.svg" alt="Note" />
                <input type="text" :value="`Nota ${noteId}`" class="bg-transparent font-better_vcr text-lg">
            </div>
